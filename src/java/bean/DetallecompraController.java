...
import dao.DetallecompraFacade;
...
public class DetallecompraController implements Serializable {
    ...
    @EJB
    private dao.DetallecompraFacade ejbFacade;
    ...
    public Detallecompra getDetallecompra(java.math.BigDecimal id) {
    ...
    public static class DetallecompraControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Detallecompra) {
                ...
                return getStringKey(o.getCoddc());
            } else {
